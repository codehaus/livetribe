...
public class CommandParametersSetter extends AbstractParametersSetter
{
    ...
    {
        PortletRequest portletRequest = ((PortletCommandContext)context).getPortletRequest();
        AttributeContainer attributes = new PortletParametersContainer(portletRequest);
