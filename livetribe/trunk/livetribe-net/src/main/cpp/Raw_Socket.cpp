...
void
LiveTribe::Raw_Socket::dump(void) const {

	ACE_TRACE ("LiveTribe::Raw_Socket::dump");
}

LiveTribe::Raw_Socket::Raw_Socket(void) {

	ACE_TRACE ("LiveTribe::Raw_Socket::Raw_Socket");
}

LiveTribe::Raw_Socket::Raw_Socket(ACE_HANDLE handle) {
...
LiveTribe::Raw_Socket::Raw_Socket(ACE_Addr const & local, int protocol, int reuse_addr) {
...
LiveTribe::Raw_Socket::Raw_Socket(int protocol, int reuse_addr) {
...
ssize_t
LiveTribe::Raw_Socket::send(void const * buf,
						    size_t n,
						    ACE_Addr const & addr,
						    int flags) const
{
...
ssize_t
LiveTribe::Raw_Socket::recv (void * buf,
                        size_t n,
                        ACE_Addr & addr,
                        int flags) const
{
...
int
LiveTribe::Raw_Socket::open (int protocol, int reuse_addr)
{
...
int
LiveTribe::Raw_Socket::bind (ACE_Addr const & local)
{
...
unsigned short
LiveTribe::Raw_Socket::calculate_checksum (unsigned short * paddress,
                                      int len)
{
  int nleft = len;
  int sum = 0;
...
int
LiveTribe::Raw_Socket::check_root_euid (void)
{
  int euid = 0;
