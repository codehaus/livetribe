...
#include "org_livetribe_net_ACERawSocketImpl.h"
#include "net_util.h"
#include <ace/ACE.h>
...
/*
 * Class:     org_livetribe_net_ACERawSocketImpl
 * Method:    bind
 * Signature: (Ljava/net/InetAddress;)V
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_bind (JNIEnv * env, jobject obj, jbyteArray laddr) {
	...
	LiveTribe_ACE::Raw_Socket raw_socket((ACE_HANDLE)fd);
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_send (JNIEnv * env, jobject socket, jobject packet) {
	int fd;
...
Java_org_livetribe_net_ACERawSocketImpl_peek (JNIEnv * env, jobject obj) {
	return NULL;
}
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_receive (JNIEnv * env, jobject obj, jobject packet) {
}
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_rawSocketCreate (JNIEnv * env, jobject obj, jint protocol) {
	int fd = 0;

	LiveTribe_ACE::Raw_Socket raw_socket((int) protocol);
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_rawSocketClose (JNIEnv * env, jobject obj) {
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_socketSetOption (JNIEnv * env, jobject obj, jint opt, jobject value) {
}
 ...
 */
JNIEXPORT jbyteArray JNICALL
Java_org_livetribe_net_ACERawSocketImpl_socketGetOption (JNIEnv * env, jobject obj, jint opt) {
	return NULL;
}
 ...
 */
JNIEXPORT void JNICALL
Java_org_livetribe_net_ACERawSocketImpl_init (JNIEnv *env, jclass cls) {
