...
import org.livetribe.s3.api.v20080201.AddressLimitExceededException;
import org.livetribe.s3.api.v20080201.AuthFailureException;
import org.livetribe.s3.api.v20080201.ConsoleOutput;
import org.livetribe.s3.api.v20080201.EC2API;
import org.livetribe.s3.api.v20080201.InstanceLimitExceededException;
import org.livetribe.s3.api.v20080201.InsufficientAddressCapacityException;
import org.livetribe.s3.api.v20080201.InsufficientInstanceCapacityException;
import org.livetribe.s3.api.v20080201.InternalErrorException;
import org.livetribe.s3.api.v20080201.InvalidAMIAttributeItemValueException;
import org.livetribe.s3.api.v20080201.InvalidAMIIDMalformedException;
import org.livetribe.s3.api.v20080201.InvalidAMIIDNotFoundException;
import org.livetribe.s3.api.v20080201.InvalidAMIIDUnavailableException;
import org.livetribe.s3.api.v20080201.InvalidGroupDuplicateException;
import org.livetribe.s3.api.v20080201.InvalidGroupInUseException;
import org.livetribe.s3.api.v20080201.InvalidGroupNotFoundException;
import org.livetribe.s3.api.v20080201.InvalidGroupReservedException;
import org.livetribe.s3.api.v20080201.InvalidInstanceIDMalformedException;
import org.livetribe.s3.api.v20080201.InvalidInstanceIDNotFoundException;
import org.livetribe.s3.api.v20080201.InvalidKeyPairDuplicateException;
import org.livetribe.s3.api.v20080201.InvalidKeyPairNotFoundException;
import org.livetribe.s3.api.v20080201.InvalidManifestException;
import org.livetribe.s3.api.v20080201.InvalidParameterCombinationException;
import org.livetribe.s3.api.v20080201.InvalidParameterValueException;
import org.livetribe.s3.api.v20080201.InvalidPermissionDuplicateException;
import org.livetribe.s3.api.v20080201.InvalidPermissionMalformedException;
import org.livetribe.s3.api.v20080201.InvalidReservationIDMalformedException;
import org.livetribe.s3.api.v20080201.InvalidReservationIDNotFoundException;
import org.livetribe.s3.api.v20080201.InvalidUserIDMalformedException;
import org.livetribe.s3.api.v20080201.KeyPair;
import org.livetribe.s3.api.v20080201.ProductInstanceConfirmation;
import org.livetribe.s3.api.v20080201.TerminatedInstance;
import org.livetribe.s3.api.v20080201.UnavailableException;
import org.livetribe.s3.api.v20080201.UnknownParameterException;
import org.livetribe.s3.jaxb.Response;
import org.livetribe.s3.jaxb.v20080201.AllocateAddressResponseType;
import org.livetribe.s3.jaxb.v20080201.AuthorizeSecurityGroupIngressResponseType;
import org.livetribe.s3.jaxb.v20080201.AvailabilityZoneItemType;
import org.livetribe.s3.jaxb.v20080201.BlockDeviceMappingItemType;
import org.livetribe.s3.jaxb.v20080201.ConfirmProductInstanceResponseType;
import org.livetribe.s3.jaxb.v20080201.CreateKeyPairResponseType;
import org.livetribe.s3.jaxb.v20080201.CreateSecurityGroupResponseType;
import org.livetribe.s3.jaxb.v20080201.DeleteKeyPairResponseType;
import org.livetribe.s3.jaxb.v20080201.DeleteSecurityGroupResponseType;
import org.livetribe.s3.jaxb.v20080201.DeregisterImageResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeAddressesResponseItemType;
import org.livetribe.s3.jaxb.v20080201.DescribeAddressesResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeAvailabilityZonesResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeImageAttributeResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeImagesResponseItemType;
import org.livetribe.s3.jaxb.v20080201.DescribeImagesResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeKeyPairsResponseItemType;
import org.livetribe.s3.jaxb.v20080201.DescribeKeyPairsResponseType;
import org.livetribe.s3.jaxb.v20080201.DescribeSecurityGroupsResponseType;
import org.livetribe.s3.jaxb.v20080201.GetConsoleOutputResponseType;
import org.livetribe.s3.jaxb.v20080201.GroupItemType;
import org.livetribe.s3.jaxb.v20080201.IpPermissionType;
import org.livetribe.s3.jaxb.v20080201.IpRangeItemType;
import org.livetribe.s3.jaxb.v20080201.LaunchPermissionItemType;
import org.livetribe.s3.jaxb.v20080201.ModifyImageAttributeResponseType;
import org.livetribe.s3.jaxb.v20080201.ProductCodeItemType;
import org.livetribe.s3.jaxb.v20080201.ProductCodesSetItemType;
import org.livetribe.s3.jaxb.v20080201.RebootInstancesResponseType;
import org.livetribe.s3.jaxb.v20080201.RegisterImageResponseType;
import org.livetribe.s3.jaxb.v20080201.ReleaseAddressResponseType;
import org.livetribe.s3.jaxb.v20080201.ReservationInfoType;
import org.livetribe.s3.jaxb.v20080201.ResetImageAttributeResponseType;
import org.livetribe.s3.jaxb.v20080201.RunningInstancesItemType;
import org.livetribe.s3.jaxb.v20080201.SecurityGroupItemType;
import org.livetribe.s3.jaxb.v20080201.TerminateInstancesResponseItemType;
import org.livetribe.s3.jaxb.v20080201.TerminateInstancesResponseType;
import org.livetribe.s3.jaxb.v20080201.UserIdGroupPairType;
import org.livetribe.s3.model.AmazonImage;
import org.livetribe.s3.model.AmazonKernelImage;
import org.livetribe.s3.model.AmazonMachineImage;
import org.livetribe.s3.model.AmazonMachineImageState;
import org.livetribe.s3.model.AmazonRamdiskImage;
import org.livetribe.s3.model.Architecture;
import org.livetribe.s3.model.AvailabilityZone;
import org.livetribe.s3.model.BlockDeviceMappingItem;
import org.livetribe.s3.model.ImageAttribute;
import org.livetribe.s3.model.ImageAttributeOperation;
import org.livetribe.s3.model.Instance;
import org.livetribe.s3.model.InstanceState;
import org.livetribe.s3.model.InstanceType;
import org.livetribe.s3.model.IpPermission;
import org.livetribe.s3.model.IpProtocol;
import org.livetribe.s3.model.LaunchPermission;
import org.livetribe.s3.model.Placement;
import org.livetribe.s3.model.ReservationInfo;
import org.livetribe.s3.model.SecurityGroup;
import org.livetribe.s3.model.UserIdGroupPair;
import org.livetribe.s3.rest.EC2Callback;
...
public final class RestEC2API implements EC2API
{
    ...
    public RestEC2API(URL url, String AWSAccessKeyId, String secretAccessKey) throws JAXBException
    {
        ...
        this.context20080201 = JAXBContext.newInstance("org.livetribe.s3.jaxb.v20080201");
    }
     ...
     * {@inheritDoc}
     */
    public String registerImage(String imageLocation) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public Set<AmazonImage> describeImages(String[] imageId, String[] owner, String[] executableBy) throws S3Exception
    {
        Map<String, String> map = new HashMap<String, String>();
     ...
     * {@inheritDoc}
     */
    public boolean deregisterImage(String imageId) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public ReservationInfo runInstances(String imageId, int minCount, int maxCount, String keyName, String[] securityGroup, String userData, InstanceType instanceType, String availabilityZone, String kernelId, String ramdiskId, String[] BDMVirtualNames, String[] BDMDeviceNames) throws S3Exception
    {
        if (imageId == null) throw new IllegalArgumentException("imageId cannot be null");
     ...
     * {@inheritDoc}
     */
    public ReservationInfo describeInstances(String[] instanceIds) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public boolean rebootInstances(String[] instanceIds) throws S3Exception
    {
        Map<String, String> map = new HashMap<String, String>();
     ...
     * {@inheritDoc}
     */
    public List<TerminatedInstance> terminateInstances(String[] instanceIds) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public ProductInstanceConfirmation confirmProductInstance(String productCode, String instanceId) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public KeyPair createKeyPair(String keyName) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public List<KeyPair> describeKeyPairs(String[] keyNames) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public boolean deleteKeyPair(String keyName) throws S3Exception
    {
        if (keyName == null) throw new IllegalArgumentException("keyName cannot be null");
     ...
     * {@inheritDoc}
     */
    public boolean modifyImageAttribute(String imageId, ImageAttribute attribute, ImageAttributeOperation operation, String[] userId, String[] userGroup, String[] productCode) throws S3Exception
    {
        if (imageId == null) throw new IllegalArgumentException("imageId cannot be null");
     ...
     * {@inheritDoc}
     */
    public Object describeImageAttribute(String imageId, ImageAttribute attribute) throws S3Exception
    {
        if (imageId == null) throw new IllegalArgumentException("imageId cannot be null");
        if (attribute == null) throw new IllegalArgumentException("attributeType cannot be null");
     ...
     * {@inheritDoc}
     */
    public boolean resetImageAttribute(String imageId, ImageAttribute attribute) throws S3Exception
    {
        if (imageId == null) throw new IllegalArgumentException("imageId cannot be null");
        if (attribute == null) throw new IllegalArgumentException("attributeType cannot be null");
     ...
     * {@inheritDoc}
     */
    public boolean createSecurityGroup(String name, String description) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public List<SecurityGroup> describeSecurityGroups(String[] names) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public boolean deleteSecurityGroup(String name) throws S3Exception
    {
        if (name == null) throw new IllegalArgumentException("Group name cannot be null");
    ...
    public boolean authorizeSecurityGroupIngress(String name,
                                                 ...
                                                 IpProtocol ipProtocol, int fromPort, int toPort, String cidrIp) throws S3Exception
    {
        if (name == null) throw new IllegalArgumentException("Group name cannot be null");
     ...
     * {@inheritDoc}
     */
    public String allocateAddress() throws S3Exception
    {
        Map<String, String> map = new HashMap<String, String>();
     ...
     * {@inheritDoc}
     */
    public Map<String, List<String>> describeAddresses(String[] publicIps) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public boolean releaseAddress(String publicIp) throws S3Exception
    {
     ...
     * {@inheritDoc}
     */
    public boolean associateAddress(String instanceId, String publicIp) throws S3Exception
    {
        if (instanceId == null) throw new IllegalArgumentException("instanceId cannot be null");
        if (publicIp == null) throw new IllegalArgumentException("publicIp cannot be null");
     ...
     * {@inheritDoc}
     */
    public boolean disassociateAddress(String publicIp) throws S3Exception
    {
        if (publicIp == null) throw new IllegalArgumentException("publicIp cannot be null");
     ...
     * {@inheritDoc}
     */
    public List<AvailabilityZone> describeAvailabilityZones(String[] zoneNames) throws S3Exception
    {
        Map<String, String> map = new HashMap<String, String>();
     ...
     * {@inheritDoc}
     */
    public ConsoleOutput getConsoleOutput(String instanceId) throws S3Exception
    {
        if (instanceId == null) throw new IllegalArgumentException("instanceId cannot be null");
     ...
     * @throws org.livetribe.s3.api.S3Exception if something goes wrong with the request or Amazon EC2 returns an error
     */
    private Object call(Map<String, String> map) throws S3Exception
    {
        ...
        {
            throw new S3Exception("Unable to sign request", se);
        }
    }
}
