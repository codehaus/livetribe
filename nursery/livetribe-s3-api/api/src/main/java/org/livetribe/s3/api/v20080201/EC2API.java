...
public interface EC2API
{
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     * @see #runInstances(String, int, int, String, String[], String, org.livetribe.s3.model.InstanceType, String, String, String, String[], String[])
     * @see #deregisterImage(String)
     */
    String registerImage(String imageLocation) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    Set<AmazonImage> describeImages(String[] imageId, String[] owner, String[] executedBy) throws S3Exception;
     ...
     * @see #deregisterImage(String)
     */
    boolean deregisterImage(String imageId) throws S3Exception;
    ...
    ReservationInfo runInstances(String imageId, int minCount, int maxCount,
                                 ...
                                 String[] BDMDeviceNames) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    ReservationInfo describeInstances(String[] instanceIds) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean rebootInstances(String[] instanceIds) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    List<TerminatedInstance> terminateInstances(String[] instanceIds) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    ProductInstanceConfirmation confirmProductInstance(String productCode, String instanceId) throws S3Exception;
     ...
     * @see #runInstances(String, int, int, String, String[], String, org.livetribe.s3.model.InstanceType, String, String, String, String[], String[])
     */
    KeyPair createKeyPair(String keyName) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    List<KeyPair> describeKeyPairs(String[] keyNames) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean deleteKeyPair(String keyName) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean modifyImageAttribute(String imageId, ImageAttribute attribute, ImageAttributeOperation operation, String[] userId, String[] userGroup, String[] productCode) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    Object describeImageAttribute(String imageId, ImageAttribute attribute) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean resetImageAttribute(String imageId, ImageAttribute attribute) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     * @see #authorizeSecurityGroupIngress(String, String, String, org.livetribe.s3.model.IpProtocol, int, int, String)
     * @see #revokeSecurityGroupIngress(String, String, String, org.livetribe.s3.model.IpProtocol, int, int, String)
     */
    boolean createSecurityGroup(String name, String description) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    List<SecurityGroup> describeSecurityGroups(String[] names) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean deleteSecurityGroup(String name) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    String allocateAddress() throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    Map<String, List<String>> describeAddresses(String[] publicIps) throws S3Exception;
     ...
     */
    boolean releaseAddress(String publicIp) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean associateAddress(String instanceId, String publicIp) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    boolean disassociateAddress(String publicIp) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    List<AvailabilityZone> describeAvailabilityZones(String[] zoneNames) throws S3Exception;
     ...
     * @throws org.livetribe.s3.api.S3Exception if any error occurs
     */
    ConsoleOutput getConsoleOutput(String instanceId) throws S3Exception;
}
