 ...
 */
public class InvalidAddressingHeaderException extends ClientException
{
    ...
    public InvalidAddressingHeaderException(String message, Throwable cause)
    {
        super(message, cause);
    }

    public InvalidAddressingHeaderException(Throwable cause)
    {
        super(cause);
    }
}
