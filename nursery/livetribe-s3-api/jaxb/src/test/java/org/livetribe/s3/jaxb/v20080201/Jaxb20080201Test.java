 ...
 */
package org.livetribe.s3.jaxb.v20080201;
...
public class Jaxb20080201Test
{
    ...
    {
        JAXBContext context20080201 = JAXBContext.newInstance("org.livetribe.s3.jaxb.v20080201");

        context20080201.createUnmarshaller().unmarshal(new StringReader("<?xml version=\"1.0\"?>\n" +
                                                                        "<DescribeImagesResponse xmlns=\"http://s3.amazonaws.com/doc/2008-02-01/\">\n" +
                                                                        "  <imagesSet>\n" +
                                                                        "    <item>\n" +
                                                                        "      <imageId>ami-be3adfd7</imageId>\n" +
                                                                        "      <imageLocation>s3-public-images/fedora-8-i386-base-v1.04.manifest.xml</imageLocation>\n" +
