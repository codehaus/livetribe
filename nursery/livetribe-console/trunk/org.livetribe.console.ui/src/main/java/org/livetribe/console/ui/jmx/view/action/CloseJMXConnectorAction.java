 ...
 */
public class CloseJMXConnectorAction implements IObjectActionDelegate
{
    @Inject
    ...
    public void run(IAction action)
    {
        ...
        {
            JMXConnectorInfo jmxConnectorInfo = (JMXConnectorInfo)((IStructuredSelection)selection).getFirstElement();
            if (jmxConnectorInfo != null)
            {
                jmxConnectorManager.close(jmxConnectorInfo);
            }
        }
    }
}
