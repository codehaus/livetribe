...
public class DefaultPopupManager implements PopupManager
{
    ...
    public void displayPopupMenu(String popupId, Context context, Component component, int x, int y)
    {
    ...
    private void newPopup(Menu menu, List<PopupSectionInfo> popupSectionInfos, Context context)
    {
