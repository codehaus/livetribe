...
public class MenuInfo
{
    ...
    {
        List<MenuSectionInfo> thisMenuSectionInfos = getMenuSectionInfos();
        if (thisMenuSectionInfos.isEmpty())
        {
            for (MenuSectionInfo otherMenuSectionInfo : other.getMenuSectionInfos()) addMenuSectionInfo(otherMenuSectionInfo);
        }
        else
        {
            Set<MenuSectionInfo> toBeMerged = new HashSet<MenuSectionInfo>();
            for (MenuSectionInfo thisMenuSectionInfo : thisMenuSectionInfos)
            {
