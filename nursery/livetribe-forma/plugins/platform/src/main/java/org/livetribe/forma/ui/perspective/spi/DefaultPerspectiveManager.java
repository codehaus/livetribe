...
public class DefaultPerspectiveManager implements PerspectiveManager
{
    ...
    public Perspective loadPerspective(String perspectiveId, PartContainer container, Context context)
    {
        ...
        perspective.spiDisplayIn(container, null);
        perspective.spiLoad(context);
        return perspective;
    }

    public Perspective openPerspective(String perspectiveId, PartContainer container, Context context)
    {
        Perspective perspective = loadPerspective(perspectiveId, container, context);
        openPerspective(perspective, context);
        return perspective;
    }

    public void openPerspective(Perspective perspective, Context context)
    {
