...
public class ApplicationAssemblerMojo extends AbstractMojo
{
    ...
    /**
     * The source location of the plugins.xml file.
     *
     * @parameter default-value="${basedir}/../modules/plugins/src/main/resources/plugins.xml"
     * @required
     */
    ...
    private void addPlugins(UnArchiver unarchiver, Archiver archiver) throws MojoExecutionException
    {
        ...
        try
        {
            FileUtils.copyFileToDirectory(pluginsXml, pluginsDirectory);
        }
        catch (IOException e)
        {
            throw new MojoExecutionException("Failed to copy plugin config file " + pluginsXml + " to assemble directory. Reason: " + e.getMessage(), e);
        }
