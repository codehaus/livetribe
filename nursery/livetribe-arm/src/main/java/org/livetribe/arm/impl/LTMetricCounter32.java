 ...
 */
class LTMetricCounter32 extends LTAbstractMetricBase implements ArmMetricCounter32
{
    private int metric;

    public LTMetricCounter32(LTAbstractFactoryBase factory, ArmMetricDefinition definition)
    {
