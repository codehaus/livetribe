 ...
 */
public class ConnectionTest extends TestCase implements ArmErrorCallback, ConnectionMonitor
{
    Throwable error;
    ...
    public void XsetUp() throws Exception
    {
        ...
        context = new ClassPathXmlApplicationContext("/org/livetribe/arm/connection/activemq/ActiveMQConnectionTest.xml");
