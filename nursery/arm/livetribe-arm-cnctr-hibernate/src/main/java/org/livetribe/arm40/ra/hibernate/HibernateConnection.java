...
{
    private final ARMDAO dao;

    HibernateConnection(ARMDAO dao)
    {
        this.dao = dao;
    }
    ...
    {
        if (dao.getIdentityPropertiesByOID(idPropOID) != null)
        {
            dao.saveIdentityProperties(new IdentityProperties(idPropOID, idNames, idValues, ctxNames));
        }
    }
