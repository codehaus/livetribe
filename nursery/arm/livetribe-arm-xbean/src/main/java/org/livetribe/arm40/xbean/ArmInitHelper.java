    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException
    {
        if (autowireFactories)
        {
            try
            {
                ...
                beanFactory.registerSingleton("org.livetribe.arm40.TransactionFactory", transactionFactory);

                MetricFactory metricFactory = new MetricFactory();
                beanFactory.registerSingleton("org.livetribe.arm40.MetricFactory", metricFactory);
