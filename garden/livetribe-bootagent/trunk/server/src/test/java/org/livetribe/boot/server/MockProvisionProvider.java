...
{
    ProvisionDirective directive = new DoNothing();

    public MockProvisionProvider()
    {
    }

    public MockProvisionProvider(ProvisionDirective directive)
    {
        this.directive = directive;
    }

    public void setDirective(ProvisionDirective directive)
    {
        this.directive = directive;
    }
